...
__exportStar(require("./is-snap-icon.cjs"), exports);
__exportStar(require("./is-snap-manifest.cjs"), exports);
__exportStar(require("./manifest-localization.cjs"), exports);
...
__exportStar(require("./icon-missing.cjs"), exports);
