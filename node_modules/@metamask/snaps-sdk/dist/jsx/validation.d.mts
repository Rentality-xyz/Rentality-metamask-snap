 ...
 */
export declare const FieldChildUnionStruct: Struct<SnapElement<import("./components/index.mjs").IconProps, "Icon"> | SnapElement<{
    src: string;
 ...
 */
export declare const BoxChildStruct: Struct<SnapElement<import("./components/index.mjs").IconProps, "Icon"> | SnapElement<{
    src: string;
    alt?: string | undefined;
}, "Image"> | SnapElement<import("./components/index.mjs").ButtonProps, "Button"> | SnapElement<import("./components/index.mjs").CheckboxProps, "Checkbox"> | SnapElement<import("./components/index.mjs").FormProps, "Form"> | SnapElement<import("./components/index.mjs").InputProps, "Input"> | SnapElement<import("./components/index.mjs").DropdownProps, "Dropdown"> | SnapElement<{
    name: string;
 ...
 */
export declare const RootJSXElementStruct: Struct<SnapElement<import("./components/index.mjs").IconProps, "Icon"> | SnapElement<{
    src: string;
    alt?: string | undefined;
}, "Image"> | SnapElement<import("./components/index.mjs").ButtonProps, "Button"> | SnapElement<import("./components/index.mjs").CheckboxProps, "Checkbox"> | SnapElement<import("./components/index.mjs").FormProps, "Form"> | SnapElement<import("./components/index.mjs").InputProps, "Input"> | SnapElement<import("./components/index.mjs").DropdownProps, "Dropdown"> | SnapElement<{
    name: string;
