...
import type { Network, RootedSLIP10PathTuple, SLIP10PathTuple } from "./constants.cjs";
...
export declare class SLIP10Node implements SLIP10NodeInterface {
     ...
     */
    static fromDerivationPath({ derivationPath, network, curve }: SLIP10DerivationPathOptions, cryptographicFunctions?: CryptographicFunctions): Promise<SLIP10Node>;
    readonly curve: SupportedCurve;
    readonly depth: number;
    readonly masterFingerprint?: number | undefined;
    readonly parentFingerprint: number;
