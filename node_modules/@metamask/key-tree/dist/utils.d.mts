import type { BIP32Node, ChangeHDPathString, CoinTypeHDPathString, CoinTypeToAddressTuple, HardenedBIP32Node, Network, UnhardenedBIP32Node, UnprefixedNode } from "./constants.mjs";
 ...
 */
export declare const getFingerprint: (publicKey: Uint8Array, compressedPublicKeyLength: number) => number;
/**
 ...
 */
export declare function validateNetwork(network: unknown): asserts network is Network | undefined;
export {};
