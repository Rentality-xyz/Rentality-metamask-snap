 ...
 */
export function getBIP44CoinTypePathString(coin_type) {
    return `m / ${BIP44PurposeNodeToken} / ${getHardenedBIP32NodeToken(coin_type)}`;
}
/**
 ...
 * and `change` indices.
 */
export function getBIP44ChangePathString(coinTypePath, indices) {
 ...
 * specified indices.
 */
export function getBIP44CoinTypeToAddressPathTuple({ account = 0, change = 0, address_index, }) {
    return [
 ...
 */
export function getHardenedBIP32NodeToken(index) {
 ...
 */
export function getUnhardenedBIP32NodeToken(index) {
    validateBIP32Index(index);
    return `bip32:${index}`;
}
/**
 ...
 */
export function getBIP32NodeToken(index) {
 ...
 */
export function validateBIP32Index(addressIndex) {
 ...
 */
export function isValidBIP32Index(index) {
 ...
 */
export function isValidBIP32PathSegment(segment) {
 ...
 */
export function isHardened(bip32Token) {
 ...
 * @returns The `Uint8Array` corresponding to the hexadecimal string.
 */
export function nullableHexStringToBytes(hexString) {
 ...
 */
export function isValidBytesKey(bytes, expectedLength) {
 ...
 * @returns The `Uint8Array` corresponding to the hexadecimal string.
 */
export function getBytes(value, length) {
 ...
 * @returns The `Uint8Array` corresponding to the hexadecimal string.
 */
export function getBytesUnsafe(value, length) {
    if (value instanceof Uint8Array) {
        assert(value.length === length, `Invalid value: Must be a ${length}-byte byte array.`);
        return value;
    }
    if (typeof value === 'string') {
...
export const decodeBase58check = (value) => {
...
export const encodeBase58check = (value) => {
    const base58Check = scureBase58check(sha256);
 ...
 */
export const getFingerprint = (publicKey, compressedPublicKeyLength) => {
 ...
 */
export function mnemonicPhraseToBytes(mnemonicPhrase) {
 ...
 */
export function validateCurve(curveName) {
    ...
    if (!Object.keys(curves).includes(curveName)) {
        throw new Error(`Invalid curve: Only the following curves are supported: ${Object.keys(curves).join(', ')}.`);
    }
}
/**
 ...
 */
export function numberToUint32(value, littleEndian = false) {
