...
import type { BIP39Node, BIP44Depth, BIP44PurposeNodeToken, CoinTypeHDPathString, HardenedBIP32Node, Network } from "./constants.cjs";
...
export declare class BIP44CoinTypeNode implements BIP44CoinTypeNodeInterface {
     ...
     * @returns A BIP44CoinType node.
     */
    static fromDerivationPath(derivationPath: CoinTypeHDPathTuple, network?: Network | undefined, cryptographicFunctions?: CryptographicFunctions): Promise<BIP44CoinTypeNode>;
    /**
     * Constructs a BIP-44 `coin_type` node. `coin_type` is the index
     * specifying the protocol for which deeper keys are intended. For the
     * authoritative list of coin types, please see
