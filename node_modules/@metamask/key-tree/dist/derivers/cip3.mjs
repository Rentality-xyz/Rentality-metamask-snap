 ...
 */
export const toReversed = (bytes) => bytes.slice().reverse();
/**
 ...
 */
export const bigIntToBytes = (bigInt) => {
 ...
 */
export const padEnd32Bytes = (bytes) => {
    return concatBytes([
        bytes,
 ...
 */
export const trunc28Mul8 = (bytes) => {
 ...
 */
export const mod2Pow256 = (bytes) => {
    return padEnd32Bytes(bigIntToBytes(mod(bytesToBigInt(bytes), BigInt(2) ** BigInt(256))));
};
/**
 ...
 * @returns PadEnd32Bytes(left + right).
 */
export const getKeyExtension = (tag, key, childIndex) => {
    return concatBytes([
        new Uint8Array([tag]),
        key,
