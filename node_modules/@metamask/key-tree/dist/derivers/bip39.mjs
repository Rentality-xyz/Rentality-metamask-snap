 ...
 * @returns The node.
 */
export async function deriveChildKey({ path, curve, network }, cryptographicFunctions) {
    switch (curve.masterNodeGenerationSpec) {
        case 'slip10':
            return createBip39KeyFromSeed(await mnemonicToSeed(path, '', cryptographicFunctions), curve, network, cryptographicFunctions);
        case 'cip3':
            return entropyToCip3MasterNode(mnemonicToEntropy(path, englishWordlist), curve, network, cryptographicFunctions);
        default:
 ...
 * code.
 */
export async function createBip39KeyFromSeed(seed, curve, network, cryptographicFunctions) {
 ...
 */
export async function entropyToCip3MasterNode(entropy, curve, network, cryptographicFunctions) {
